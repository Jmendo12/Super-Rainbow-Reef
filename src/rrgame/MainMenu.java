...
public class MainMenu{
    ...
    public MainMenu(Game currentGame){
        game = currentGame;
        fileList.add(new File("./resources/Button_start.gif"));
        fileList.add(new File("./resources/Button_help.gif"));
        fileList.add(new File("./resources/Button_scores.gif"));
        fileList.add(new File("./resources/Button_quit.gif"));
        fileList.add(new File("./resources/highscore.txt"));
        options = new BufferedImage[fileList.size() - 1];
        try{
           backImage = ImageIO.read(new File("./resources/Title.png"));
           helpImage = ImageIO.read(new File("./resources/helpPage.png"));
           scoreImage = ImageIO.read(new File("./resources/scoreImage.png"));
