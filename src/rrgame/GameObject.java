 ...
 */
 public abstract class GameObject implements Observer{
    ...
    static{
        ...
        try{
            BufferedImage bigleg = ImageIO.read(new File("./resources/Bigleg.gif"));
            BufferedImage block1 = ImageIO.read(new File("./resources/Block1.gif"));
            BufferedImage block2 = ImageIO.read(new File("./resources/Block2.gif"));
            BufferedImage block3 = ImageIO.read(new File("./resources/Block3.gif"));
            BufferedImage block4 = ImageIO.read(new File("./resources/Block4.gif"));
            BufferedImage block5 = ImageIO.read(new File("./resources/Block5.gif"));
            BufferedImage block6 = ImageIO.read(new File("./resources/Block6.gif"));
            BufferedImage block7 = ImageIO.read(new File("./resources/Block7.gif"));
            BufferedImage blockDouble = ImageIO.read(new File("./resources/Block_double.gif"));
            BufferedImage blockLife = ImageIO.read(new File("./resources/Block_life.gif"));
            BufferedImage blockSolid = ImageIO.read(new File("./resources/Block_solid.gif"));
            BufferedImage blockSplit = ImageIO.read(new File("./resources/Block_split.gif"));
            BufferedImage katch = ImageIO.read(new File("./resources/Katch.gif"));
            BufferedImage pop = ImageIO.read(new File("./resources/pop.png"));
